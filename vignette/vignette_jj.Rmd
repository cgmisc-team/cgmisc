...
The **cgmisc** package is available on GitHub repository and can be easily installed with the help of devotees package:
...
```{r plot_qq, eval=TRUE, echo=TRUE}
plot.qq(mm[,'P1df'], conf=c(0.05, 0.95), conf.type="shade", conf.col=rgb(.5,.5,1,.5), step=1)
```
