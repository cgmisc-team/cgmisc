...
knitr::opts_chunk$set(fig.width=8.2, fig.height=4.5, tidy = FALSE)
```
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE, eval=T}
...
```{r geno_box, echo = F, results='hide', eval = F, warning=F}
...
```{r open_ucsc, echo=TRUE, results='show', message=FALSE, warning=FALSE, eval=T}
...
```{r epistasis_scan, echo=FALSE, results='hide', message=FALSE, warning=FALSE, eval=T}
es <- epistasis.scan(data = data.qc1[,data.qc1@gtdata@chromosome==2], SNP = 'BICF2S2365880', trait.name = 'response')
```

```{r box_two}
boxplot.snp.twoWay(data.qc1, marker1 = 'BICF2S2365880', marker2 = 'BICF2S2337600', trait = 'response')
```
